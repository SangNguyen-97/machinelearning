...
mdl = fitcsvm(pca_xtrain,ytrain,"KernelFunction","polynomial","Standardize",true);
...
% Calculating stats
iswrongneg = (pred ~= ytest) & (pred == "Not Object 1");
istrueneg = (pred == ytest) & (pred == "Not Object 1");
FN = sum(iswrongneg);
TN = sum(istrueneg);
...
% missRate = loss(mdl,testdata,"Object");
